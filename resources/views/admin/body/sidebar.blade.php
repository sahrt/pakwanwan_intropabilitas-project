<aside class="main-sidebar">
    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          <a href="#">
            <i data-feather="mail"></i> <span>Karyawan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <li><a href="{{ route('karyawan.view') }}"><i class="ti-more"></i>Tampilkan Karyawan</a></li>
            <li><a href="calendar.html"><i class="ti-more"></i>Tambah Karyawan</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          <a href="#">
            ...
            <span>Daftar Kucing</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{route('kucing.view')}}"><i class="ti-more"></i>Tampilkan Kucing</a></li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
	      <li><a href="{{route('kuliah.view')}}"><i class="ti-more"></i>Tampilkan Kuliah</a></li>
		  </ul>
        </li>  
